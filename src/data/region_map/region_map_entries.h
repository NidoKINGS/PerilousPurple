...
const struct RegionMapLocation gRegionMapEntries[] = {
    ...
    [MAPSEC_HEMLOCK_VILLAGE] = {
        .x = 0,
        .y = 0,
        .width = 1,
        .height = 1,
        .name = sMapName_Hemlock_Village,
    },
    [MAPSEC_ALDER_TOWN] = {
        .x = 0,
        .y = 0,
        .width = 1,
        .height = 1,
        .name = sMapName_Alder_Town,
    },
    [MAPSEC_KEYSTONE_CITY] = {
        .x = 0,
        .y = 0,
        .width = 1,
        .height = 1,
        .name = sMapName_Keystone_City,
    },
    [MAPSEC_ROUTE_01] = {
        .x = 0,
        .y = 0,
