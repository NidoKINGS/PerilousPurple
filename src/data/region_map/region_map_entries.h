...
const struct RegionMapLocation gRegionMapEntries[] = {
    ...
    [MAPSEC_HEMLOCK_VILLAGE] = {
        ...
        .width = 1,
        .height = 1,
        .name = COMPOUND_STRING("Hemlock Village"),
    },
    [MAPSEC_ALDER_TOWN] = {
        .x = 0,
        .y = 0,
        .width = 1,
        .height = 1,
        .name = COMPOUND_STRING("Alder Town"),
    },
    [MAPSEC_KEYSTONE_CITY] = {
        ...
        .width = 1,
        .height = 1,
        .name = COMPOUND_STRING("Keystone City"),
    },
    [MAPSEC_ROUTE_01] = {
        .x = 0,
        .y = 0,
