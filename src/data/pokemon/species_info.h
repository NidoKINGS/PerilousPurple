...
const struct SpeciesInfo gSpeciesInfo[] =
{
    ...
    */
    ...
    [SPECIES_BUNEARY_CORDISIAN] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_LOPUNNY_CORDISIAN, CONDITIONS({IF_MIN_FRIENDSHIP, FRIENDSHIP_EVO_THRESHOLD})}),
    ...
    [SPECIES_LOPUNNY_CORDISIAN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_FUR_COAT, ABILITY_LIMBER, ABILITY_TECHNICIAN},
        .bodyColor = BODY_COLOR_GRAY,
