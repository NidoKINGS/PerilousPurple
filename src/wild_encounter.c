...
enum TimeOfDay GetTimeOfDayForEncounters(u32 headerId, enum WildPokemonArea area)
{
    ...
    if (InBattlePike()) 
    {
        ...
        case WILD_AREA_HEADBUTT:
            wildMonInfo = gBattlePikeWildMonHeaders[headerId].encounterTypes[timeOfDay].headbuttMonsInfo;
            break;
    ...
    else if (InBattlePyramid())
    {
        ...
        case WILD_AREA_FISHING:
            ...
            break;
        case WILD_AREA_HEADBUTT:
            wildMonInfo = gBattlePyramidWildMonHeaders[headerId].encounterTypes[timeOfDay].headbuttMonsInfo;
            break;
        case WILD_AREA_HIDDEN:
