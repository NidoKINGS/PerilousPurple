...
const u8 gHealthboxElementsGfxTable[][32] = INCBIN_U8("graphics/battle_interface/hpbar.4bpp",
                                                  ...
                                                  "graphics/battle_interface/healthbox_shiny_icon.4bpp");
...
const u16 gSwapLinePal[] = INCBIN_U16("graphics/interface/swap_line.gbapal.lz");
...
const u16 gTitleScreenBgPalettes[]         = INCBIN_U16("graphics/title_screen/pokemon_logo.gbapal",
                                                        "graphics/title_screen/giratinatitlenew.gbapal");
